...
Usage:
    python3 event-log/shortcuts/generate-health-sync.py   # writes event-log/shortcuts/generated/health-sync.shortcut
"""
...
def build():
    actions = [
        comment(
            ...
            "from event-log/shortcuts/health-sync.md, then delete the empty Set Variable\n"
...
print("Health reads marked '>> ADD' following event-log/shortcuts/health-sync.md.")
